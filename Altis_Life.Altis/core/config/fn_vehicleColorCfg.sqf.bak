...
switch (_vehicle) do
{
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\hunter_sek_front1.paa","cop","textures\hunter_sek_hinten1.paa"],
			["textures\hunter_polizei_front1.paa","cop","textures\hunter_polizei_hinten1.paa"],
			["textures\hunter_polizei_front2.paa","cop","textures\hunter_polizei_hinten2.paa"]
		];
	};
